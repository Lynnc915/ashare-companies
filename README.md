...
- 按上市日期范围筛选
- 展示企业 **2022 / 2023 / 2024 年度营业总收入和净利润**
- 点击企业行展开详情，查看招股书链接
- 点击表头排序、分页浏览
...
默认抓取 2022 年 1 月 1 日至今上市的企业，并抓取 2022–2024 年度财务数据：

```bash
python3 update_data.py
```

> 由于需要抓取财务数据，首次运行可能需要 **1–3 分钟**，请耐心等待。
...
| 日期筛选 | 按上市日期起止范围过滤 |
| 财务数据 | 表格默认显示最新年度营收和净利润，点击行展开查看 2022–2024 三年数据 |
